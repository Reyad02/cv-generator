...
system_prompt = """
You are a cover letter expert AI assistant. You should format the user details for a cover letter. You should check any spelling mistakes, grammar mistakes etc. You also refine the about me and other description sections to make them more professional and impactful. For format the details use only '\n' for new lines not any bullets or dashes.
User details 
------------------
{details}
...
async def refine_cover_letter(request: UserDetailsRequest):
    ...
    response = client.responses.create(
        model="gpt-5-nano",
        input=[
            {"role": "system", "content": "You are a helpful assistant to refine user details for a cover letter."},
